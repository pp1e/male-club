...
import EventsPage from './components/EventsPage/_recordCards/EventsPage';
import StartPage from "./components/StartPage/StartPage";
import PersonalAccount from './components/PersonalAccount/_accountCardList/PersonalAccount';
